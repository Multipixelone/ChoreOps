...
_ROTATION_FAIRNESS_BASIS_VALUES = [
    ...
    _with_service_target_fields(
        {
            ...
            vol.Optional(
                const.SERVICE_FIELD_CHORE_CRUD_ROTATION_FAIRNESS_BASIS
            ): vol.In(_ROTATION_FAIRNESS_BASIS_VALUES),
...
_SERVICE_TO_CHORE_DATA_MAPPING: dict[str, str] = {
    ...
    const.SERVICE_FIELD_CHORE_CRUD_ROTATION_FAIRNESS_BASIS: const.DATA_CHORE_ROTATION_FAIRNESS_BASIS,
